...
"""
Complete code for the Chaos Cryptography Application
This file is for reference/copying only and won't run automatically
"""
...
<body>
    <div class="container">
        ...
        <form method="POST">
            <div class="form-group">
                <label>Encrypted Message (as array):</label>
            ...
            <div class="button-group">
                ...
                <a href="/encrypt" class="button">Go to Encrypt</a>
                <a href="/" class="button secondary">Back to Home</a>
            </div>
        </form>
        {% if result %}
